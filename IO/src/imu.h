...
struct MotionData
{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW //Eigen字节对其操作
    double timestamp;
    Eigen::Matrix3d Rwb;
    Eigen::Vector3d twb;
    ...
    Eigen::Vector3d imu_gyro_bias; //IMU 陀螺仪 偏差
    Eigen::Vector3d imu_acc_bias;   //IMU 加速度 偏差
    Eigen::Vector3d imu_velocity;   //IMU 速度
};
